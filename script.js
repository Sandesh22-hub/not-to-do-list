...
document.getElementById("form-btn").addEventListener("click", (e) => {
  ...
  const totalAlllocatedHrs = totalTaskHours();
  if (totalAlllocatedHrs + +hr > hrsPerWeek) {
    return alert(
...
const totalBadTaskHours = () => {
  ...
  document.querySelector("#totalBadHrs").innerHTML = total;
  return total;
};
...
const totalTaskHours = () => {
  ...
  document.querySelector("#totalHrs").innerHTML = total + totalBadTaskHours();
  return total;
};
